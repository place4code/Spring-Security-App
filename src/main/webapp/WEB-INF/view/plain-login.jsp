  ...
  <div class="row justify-content-center">
    ...
    <c:if test="${param.error != null}">
    	<div class="alert alert-danger" role="alert">
  			<i class="fas fa-exclamation"></i> Sorry, invalid username/password
		</div>
    </c:if>
    <c:if test="${param.logout != null}">
    	<div class="alert alert-success" role="alert">
  			<i class="fas fa-check"></i> You have been logged out
		</div>
    </c:if>
<form:form action="${pageContext.request.contextPath}/authUser" method="POST">
  <div class="form-group">
    <label for="login">Login</label>
    <input type="text" class="form-control" id="login" aria-describedby="login" placeholder="Enter login" name="username">
  </div>
  <div class="form-group">
